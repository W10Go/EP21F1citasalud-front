      ...
      <div className="flex flex-col flex-1 items-center justify-center bg-gray-100 py-12 px-4">
        ...
        <section className="bg-white shadow-md rounded-xl p-8 max-w-3xl w-full">
          <p className="text-base text-gray-700 leading-relaxed">
            ...
            sector salud digital, destacándonos por la innovación, la confianza
            y el compromiso con el bienestar de las personas es nuestra
            prioridad.
          </p>
        </section>
      </div>
          ...
          <div className="bg-white p-6 rounded shadow-lg max-w-lg w-full relative">
            ...
            <div className="mb-4 max-h-80 overflow-y-auto text-sm">
              <p>
                ...
                utilizar nuestra plataforma, aceptas las siguientes condiciones
